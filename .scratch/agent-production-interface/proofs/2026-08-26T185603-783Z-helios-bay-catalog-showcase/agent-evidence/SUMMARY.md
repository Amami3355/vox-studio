...
- Context: 1 model ask, 126,040 characters (~42,014 tokens) put in front of a model, of which 0 is the teaching surface re-sent unchanged and eligible for a provider cache the crew does not measure
