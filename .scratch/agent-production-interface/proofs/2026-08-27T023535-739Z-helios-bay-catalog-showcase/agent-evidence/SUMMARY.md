...
- Context: 1 model ask over 2 model calls, 251,031 characters (~83,677 tokens) put in front of a model, of which 124,614 is the teaching surface re-sent unchanged and eligible for a provider cache the crew does not measure
