...
describe('a declared composition renders into the rectangle it declared', () => {
  it('has a case for every composition in the catalog', () => {
    ...
    expect(cases.map((one) => one.label)).toEqual([
      ...
      'image_detail composed into full under cinematic',
      'image_detail composed into full under pushIn',
      'process_steps composed into full under cinematic',
      'process_steps composed into full under pushIn',
